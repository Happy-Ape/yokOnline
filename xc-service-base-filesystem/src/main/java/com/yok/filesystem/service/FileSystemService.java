package com.yok.filesystem.service;

import com.alibaba.fastjson.JSON;
import com.yok.filesystem.dao.FileSystemRepository;
import com.yok.framework.domain.filesystem.FileSystem;
import com.yok.framework.domain.filesystem.response.FileSystemCode;
...
public class FileSystemService {
    ...
    @Value("${yok.fastdfs.tracker_servers}")
    String tracker_servers;
    @Value("${yok.fastdfs.connect_timeout_in_seconds}")
    int connect_timeout_in_seconds;
    @Value("${yok.fastdfs.network_timeout_in_seconds}")
    int network_timeout_in_seconds;
    @Value("${yok.fastdfs.charset}")
    String charset;
