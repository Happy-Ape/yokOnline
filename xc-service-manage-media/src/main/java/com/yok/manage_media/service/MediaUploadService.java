...
import com.yok.framework.domain.media.response.CheckChunkResult;
...
import com.yok.manage_media.config.RabbitMQConfig;
...
public class MediaUploadService {
    ...
    public ResponseResult sendProcessVideoMsg(String mediaId){
        ...
        try {
            ...
            e.printStackTrace();
            LOGGER.info("Send media process task error,msg is:{},error is:{} ",jsonString,e.getMessage());
